...
import kotlinx.android.synthetic.main.product_view_adapter_grid.view.*

class ProductAdapterGrid(var mContext: Context, var myList:ArrayList<Product> ): RecyclerView.Adapter<ProductAdapterGrid.MyViewHolder>(){


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        var view = LayoutInflater.from(mContext).inflate(R.layout.product_view_adapter_grid,parent,false)
